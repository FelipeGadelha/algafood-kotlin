...
ALTER TABLE orders ADD CONSTRAINT FK_orders_address_city FOREIGN KEY (address_city_id) REFERENCES cities;
ALTER TABLE orders ADD CONSTRAINT FK_orders_restaurant FOREIGN KEY (restaurant_id) REFERENCES restaurants;
ALTER TABLE orders ADD CONSTRAINT FK_orders_user_client FOREIGN KEY (user_client_id) REFERENCES users;
ALTER TABLE orders ADD CONSTRAINT FK_orders_payment_method FOREIGN KEY (payment_method_id) REFERENCES payment_methods;
