...
DELETE FROM restaurants_payment_methods;
DELETE FROM users;
...
INSERT INTO kitchens (id, name) VALUES (3, 'Australiana');
INSERT INTO kitchens (id, name) VALUES (4, 'Mexicana');
INSERT INTO kitchens (id, name) VALUES (5, 'Francesa');
INSERT INTO kitchens (id, name) VALUES (6, 'Italinana');

SELECT nextval ('kitchens_id_seq');
SELECT nextval ('kitchens_id_seq');
SELECT nextval ('kitchens_id_seq');
SELECT nextval ('kitchens_id_seq');
SELECT nextval ('kitchens_id_seq');
...
INSERT INTO Restaurants (id, name, tax_freight, kitchen_id, creation_date, update_date, active, open, address_city_id, address_cep, address_place, address_number, address_district) VALUES (1, 'Thai Gourmet', 10, 1, now(), now(), true, true, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro');
INSERT INTO Restaurants (id, name, tax_freight, kitchen_id, creation_date, update_date, active, open) VALUES (2, 'Coco Bambu', 100.0, 1, now(), now(), true, true);
INSERT INTO Restaurants (id, name, tax_freight, kitchen_id, creation_date, update_date, active, open) VALUES (3, 'Outback', 150.50, 3, now(), now(), true, true);
INSERT INTO Restaurants (id, name, tax_freight, kitchen_id, creation_date, update_date, active, open) VALUES (4, 'Paris 6', 150.50, 5, now(), now(), true, true);
INSERT INTO Restaurants (id, name, tax_freight, kitchen_id, creation_date, update_date, active, open) VALUES (5, 'Sí Señor', 80.0, 4, now(), now(), true, true);
INSERT INTO Restaurants (id, name, tax_freight, kitchen_id, creation_date, update_date, active, open) VALUES (6, 'terraço italia', 90.0, 6, now(), now(), true, true);

SELECT nextval ('restaurants_id_seq');
SELECT nextval ('restaurants_id_seq');
SELECT nextval ('restaurants_id_seq');
SELECT nextval ('restaurants_id_seq');
SELECT nextval ('restaurants_id_seq');
...
INSERT INTO payment_methods (id, description) VALUES (1, 'cartão de credito');
INSERT INTO payment_methods (id, description) VALUES (2, 'cartão de debito');
INSERT INTO payment_methods (id, description) VALUES (3, 'boleto');

SELECT nextval ('payment_methods_id_seq');
SELECT nextval ('payment_methods_id_seq');
SELECT nextval ('payment_methods_id_seq');
...
INSERT INTO permissions (id, name, description) VALUES (3, 'EXCLUIR_COZINHAS', 'Permite exclusão de cozinhas');
...
--INSERT INTO products (id, name, description, price, active, restaurant_id) VALUES
INSERT INTO products (id, name, description, price, active, restaurant_id) VALUES
...
INSERT INTO restaurants_payment_methods (restaurant_id, payment_method_id) VALUES (1, 1), (1, 2), (1, 3), (2, 3), (3, 2), (3, 3);
INSERT INTO groups_permissions (groups_id, permissions_id) VALUES (1, 1), (1, 2), (1, 3), (2, 3), (3, 2), (3, 3);
